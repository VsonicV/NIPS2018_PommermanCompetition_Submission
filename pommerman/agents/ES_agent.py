...
class ESAgent(BaseAgent):
    ...
    def act(self, obs, action_space):
        ...
        '''
        agent_row = obs['position'][0]
        agent_col = obs['position'][1]
        if agent_row > 0 and obs['board'][agent_row-1][agent_col] == 4:
            ac_scores[1] = 0
        if agent_row < 10 and obs['board'][agent_row+1][agent_col] == 4:
            ac_scores[2] = 0
        if agent_col > 0 and obs['board'][agent_row][agent_col-1] == 4:
            ac_scores[3] = 0
        if agent_col < 10 and obs['board'][agent_row][agent_col+1] == 4:
            ac_scores[4] = 0
        '''
